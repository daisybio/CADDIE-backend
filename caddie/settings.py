"""
Django settings for caddie project.
...
WSGI_APPLICATION = 'caddie.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': f'redis://{os.environ.get("REDIS_HOST", "caddie_redis")}:{os.environ.get("REDIS_PORT", "6379")}/1',
        'OPTIONS': {
...
redis_config = {
    'host': os.getenv('REDIS_HOST', 'caddie_redis'),
